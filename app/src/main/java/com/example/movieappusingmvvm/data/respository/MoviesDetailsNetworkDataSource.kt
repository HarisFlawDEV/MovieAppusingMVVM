...
class MoviesDetailsNetworkDataSource(
    ...
    private val _downloadedMovieDetailsResponse = MutableLiveData<PopularMoviesDetails>()
    val downloadedMovieResponse : LiveData<PopularMoviesDetails>
